...
label: WorkflowNo_0
doc: A workflow including the tool(s) create_project, create_structure_genericbulk, create_job_lammps, select_potential_lammps_farkas, calc_md, run_job_lammps, get_output_MD.
