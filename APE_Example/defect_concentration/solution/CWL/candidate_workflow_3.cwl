...
label: WorkflowNo_2
doc: A workflow including the tool(s) create_project, create_structure_bulk, create_vacancy_Fe, create_antisite_Fe, relax_structure, calculate_defect_formation_energy, calc_defect_concentration.
...
steps:
  ...
  relax_structure_05:
    ...
    in:
      relax_structure_in_1: create_antisite_Fe_04/create_antisite_Fe_out_1
  ...
  calculate_defect_formation_energy_06:
    ...
    in:
      calculate_defect_formation_energy_in_1: relax_structure_05/relax_structure_out_1
