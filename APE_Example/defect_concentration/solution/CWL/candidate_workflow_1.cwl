...
label: WorkflowNo_0
doc: A workflow including the tool(s) create_project, create_structure_bulk, create_antisite_Fe, calc_chemical_potential_A, create_vacancy_Al, relax_structure, calculate_dfe_1AS_1Vac_AB, calc_chemical_potential_B, calc_defect_concentration.
...
steps:
  ...
  relax_structure_06:
    ...
    in:
      relax_structure_in_1: create_vacancy_Al_05/create_vacancy_Al_out_1
