...
label: WorkflowNo_3
doc: A workflow including the tool(s) create_project, get_chemical_potential, create_structure_bulk, create_vacancy_Fe, create_antisite_Al, relax_structure, calculate_dfe_1AS_1Vac_AB, calc_defect_concentration.
...
steps:
  ...
  create_antisite_Al_05:
    ...
    in:
      create_antisite_Al_in_1: create_vacancy_Fe_04/create_vacancy_Fe_out_1
  ...
  calculate_dfe_1AS_1Vac_AB_07:
    ...
    in:
      calculate_dfe_1AS_1Vac_AB_in_1: create_structure_bulk_03/create_structure_bulk_out_1
