...
label: WorkflowNo_3
doc: A workflow including the tool(s) create_project, create_structure_bulk, get_chemical_potential, create_vacancy_Al, relax_structure, calculate_vacancy_formation_energy, calc_defect_concentration.
...
steps:
  ...
  calc_defect_concentration_07:
    ...
    in:
      ...
      calc_defect_concentration_in_2: get_chemical_potential_03/get_chemical_potential_out_1
