...
label: WorkflowNo_3
doc: A workflow including the tool(s) create_project, create_structure_bulk, create_vacancy_Al, relax_structure, calculate_vacancy_formation_energy, get_chemical_potential, calc_defect_concentration.
...
steps:
  ...
  calc_defect_concentration_07:
    ...
    in:
      calc_defect_concentration_in_1: calculate_vacancy_formation_energy_05/calculate_vacancy_formation_energy_out_1
