...
label: WorkflowNo_4
doc: A workflow including the tool(s) create_project, get_chemical_potential, create_structure_bulk, create_antisite_Fe, relax_structure, calculate_antisite_formation_energy, calc_defect_concentration.
...
steps:
  ...
  create_antisite_Fe_04:
    ...
    in:
      create_antisite_Fe_in_1: create_structure_bulk_03/create_structure_bulk_out_1
  ...
  calculate_antisite_formation_energy_06:
    ...
    in:
      calculate_antisite_formation_energy_in_1: relax_structure_05/relax_structure_out_1
      calculate_antisite_formation_energy_in_2: create_structure_bulk_03/create_structure_bulk_out_1
