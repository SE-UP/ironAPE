...
label: WorkflowNo_4
doc: A workflow including the tool(s) create_project, create_structure_bulk, create_vacancy_Fe, create_vacancy_Fe, relax_structure, calculate_defect_formation_energy, calc_defect_concentration.
...
steps:
  ...
  create_vacancy_Fe_04:
    run: add-path-to-the-implementation/http://www.semanticweb.org/materials_science#create_vacancy_Fe.cwl 
    in:
      create_vacancy_Fe_in_1: create_vacancy_Fe_03/create_vacancy_Fe_out_1
    out: [create_vacancy_Fe_out_1]
  relax_structure_05:
